package com.two.mylibrary.bottomnavigation;
...
public class BottomNavigationViewInner extends BottomNavigationView {
    ...
    public BottomNavigationViewInner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context, attrs,
                ...
                defStyleAttr,   com.google.android.material.R.style.Widget_Design_BottomNavigationView, 0,0);
        // clear if you don't have set item icon tint list
        if (!a.hasValue(  com.google.android.material.R.styleable.BottomAppBar_navigationIconTint)) {
            clearIconTintColor();
        }
        a.recycle();
    }
...
//        mMenuView.updateMenuView();
     ...
     * @return
     */
    public NavigationBarView.OnItemSelectedListener getOnNavigationItemSelectedListener() {
        // private OnNavigationItemSelectedListener mListener;
        NavigationBarView.OnItemSelectedListener mListener = getField(BottomNavigationView.class, this, "selectedListener");
        return mListener;
    }
    ...
    public BottomNavigationViewInner setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        ...
        NavigationBarView.OnItemSelectedListener listener = getOnNavigationItemSelectedListener();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
     ...
     */
    private static class MyOnNavigationItemSelectedListener implements NavigationBarView.OnItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavigationViewInner bnve, boolean smoothScroll, NavigationBarView.OnItemSelectedListener listener) {
        ...
        public void setOnNavigationItemSelectedListener(NavigationBarView.OnItemSelectedListener listener) {
            this.listener = listener;
        }
