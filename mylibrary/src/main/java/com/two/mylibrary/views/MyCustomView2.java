package com.two.mylibrary.views;
...
import com.two.mylibrary.databinding.LayoutMycustomview2Binding;
import com.two.mylibrary.databinding.LayoutMycustomviewBinding;
import com.two.mylibrary.views.baseClasses.globalEnums.ListStatus;
import com.two.mylibrary.views.baseClasses.globalEnums.ScrollDirection;
import com.two.mylibrary.views.globalInterface.MyCustomViewCallBack;
import com.two.mylibrary.views.globalInterface.MyCustomViewScrollCallBack;
import com.two.mylibrary.views.shimmer.ShimmerRecyclerView;
import com.two.mylibrary.views.utils.PublicFunction;
...
public class MyCustomView2 extends RelativeLayout implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {

    private Context context;
    private LayoutMycustomview2Binding myCustomViewBinding;
    ...
    public MyCustomView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
    }

    public MyCustomView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        //myCustomViewBinding=  LayoutMycustomviewBinding.inflate(inflater,this,true);
        myCustomViewBinding = DataBindingUtil.inflate(inflater, R.layout.layout_mycustomview2, this, true);
        setColor(attrs);
        ...
        myCustomViewBinding.layoutRecyclerView.recyclerView2.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
    ...
    public ShimmerRecyclerView getRecyclerView() {
        return myCustomViewBinding.layoutRecyclerView.recyclerView2;
    }
    ...
    private void showRecyclerView() {
        myCustomViewBinding.layoutRecyclerView.recyclerView2.setVisibility(VISIBLE);
    }

    private void hideRecyclerView() {
        myCustomViewBinding.layoutRecyclerView.recyclerView2.setVisibility(INVISIBLE);
    }
